...
*/
$(function(){
	$(document).on('focus', '.form-group-options div.input-group-option:last-child input > div', function(){
		var sInputGroupHtml = $(this).parent().html();
		var sInputGroupClasses = $(this).parent().attr('class');
		$(this).parent().parent().append('<div class="'+sInputGroupClasses+'">'+sInputGroupHtml+'</div>');
	});
	
	$(document).on('click', '.form-group-options .input-group-addon-remove > div', function(){
		$(this).parent().remove();
	});
});
