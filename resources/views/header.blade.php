...
<head>
    ...
    <title>E-Performance V.2 | Kementerian PPN/Bappenas</title>
    ...
    <!-- Dynamic Field 
    <link href="{{ asset('css/dynamic-field.css') }}" rel="stylesheet">
    <script type="text/javascript" src="js/dynamic-field.js"></script>
